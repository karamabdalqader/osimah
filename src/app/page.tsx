...
const Services = dynamic(() => import("@/components/osimah/services").then((mod) => mod.Services));
const Stats = dynamic(() => import("@/components/osimah/stats").then((mod) => mod.Stats));
const Leadership = dynamic(() => import("@/components/osimah/leadership").then((mod) => mod.Leadership));
const Projects = dynamic(() => import("@/components/osimah/projects").then((mod) => mod.Projects));
const CircularTestimonials = dynamic(() =>
  import("@/components/osimah/circular-testimonials").then((mod) => mod.CircularTestimonials)
);
const Strategy = dynamic(() => import("@/components/osimah/strategy").then((mod) => mod.Strategy));
const Brands = dynamic(() => import("@/components/osimah/brands").then((mod) => mod.Brands));
const Faq = dynamic(() => import("@/components/osimah/faq").then((mod) => mod.Faq));
const Cta = dynamic(() => import("@/components/osimah/cta").then((mod) => mod.Cta));
